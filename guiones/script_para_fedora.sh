...
#x='cut -d " " -f 1 /etc/issue | head -n 1'
...
git clone https://github.com/atom/atom/releases/tag/v1.0.19/atom.x86_64.rpm
dnf -y install atom.x86_64.rpm

#instalamos el paquete de herramientas de desarrollo, que trae muchas utilidades
dnf group install "Herramientas de desarrollo"

#instalamos el paquete eclipse
dnf group install "Fedora Ecipse"
